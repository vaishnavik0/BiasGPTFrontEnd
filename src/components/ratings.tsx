                      ...
                      className={`flex items-center justify-center px-4 h-10 leading-tight rounded-lg border border-[#0C0F19] hover:bg-gray-100 hover:text-gray-700 ${
                        selectedRating
                          ? selectedRating === item.rating
                            ? "bg-white text-black"
                            : "opacity-10 cursor-not-allowed text-white"
                          : "bg-transparent"
                      } dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white cursor-pointer`}
                      onClick={() => (!handleClick ? handleRating(item) : null)}
                    >
                      {item?.rating}
                    </li>
                  </TooltipTrigger>
